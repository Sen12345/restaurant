...
@section('content')
        ...
        <div class=" text-left my-3 m-auto"  style="width:50%">
            ...
            <div class="title text-center "> CREATE BREAKFAST DISH</div>

            <form action="{{ url('createBreakfast') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <input class="form-control text-white" type="file" name="breakfast">
                    </div>
