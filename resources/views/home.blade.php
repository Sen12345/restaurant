            ...
            <div class="row">
                <div class="col-lg-4 ">
                    <div class="left-content">
                        <div class="inner-content w-100 text-center">
                            <h4>Cool Breeze</h4>
                            <h6>THE BEST EXPERIENCE</h6>
                            <div class="main-white-button scroll-to-section">
                                <a href="{{ url('confirmorder') }}">Make A Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>About Us</h6>
                            <h2>We Leave A Delicious Memory with You</h2>
                        </div>
                        <p>Everything we do is a celebration of Jamaican cuisine. From how we source our dishes to serving up new ways for you to enjoy it. Since 2012, we have being committed to bringing you the best experience at Mama's Pot you won't find anywhere else.</p>
                        <div class="row">
                            <div class="col-4">
                                <img src="assets/images/about-1.jfif" alt="">
                                {{-- <img src="assets/images/about-thumb-01.jpg" alt=""> --}}
                            </div>

                            <div class="col-4">
                                {{-- <img src="assets/images/about-thumb-03.jpg" alt="">  --}}
                                <img src="assets/images/about-3.jfif" alt="">
                            </div>
                            <div class="col-4">
                                <img src="assets/images/about-2.jfif" alt="">
